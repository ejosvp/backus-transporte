...
/**
 * Carreta form base class.
 *
 * @method Carreta getObject() Returns the current form's model object
 *
 * @package    transporte
 * @subpackage form
 * @author     ejosvp
 ...
 */
abstract class BaseCarretaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('carreta[%s]');
