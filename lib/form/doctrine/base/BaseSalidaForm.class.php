...
abstract class BaseSalidaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'carreta_id'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Carreta'), 'required' => false)),
      ...
      'guia2'         => new sfValidatorString(array('max_length' => 15, 'required' => false)),
