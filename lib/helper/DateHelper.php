...
function distance_of_time_in_words($from_time, $to_time = null, $include_seconds = false)
{
  ...
  {
    $string = 'alrededor de 1 hora';
  }
  else if ($distance_in_minutes >= 90 && $distance_in_minutes <= 1439)
  {
    $string = 'alrededor de %hours% horas';
  ...
  {
    $string = 'alrededor de 1 año';
  }
  else
  {
    $string = 'mas de %years% años';
...
function time_unix_to_number($tiempo, $segundos = true)
{
  $segundos = $tiempo % 60;
